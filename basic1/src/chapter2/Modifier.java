...
class ModifierCombination {
	...
	// public + static + final 의 변수, 메서드
	// 주로 많이 사용함!
	public static final int NUMBER = 10;
	
	// 변수에서 private + final
	// 필드에서 final 은 생성자에서 필수로 초기화 해야 함을 의미
	private final String name;
	ModifierCombination () {
		name = "홍길동";
	}
	
	// 메서드에서 private + final (final 의 의미가 없음.)
...
abstract class SuperClass1 {
	...
	// private abstract void method(); // : 선언부, {} : 구현부
...
public class Modifier {
	...
	public static void main(String[] args) {
		...
		// static 제어자가 붙은 메서드, 변수 클래스로 바로 호출 가능
