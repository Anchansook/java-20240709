...
public class Package3 {
	...
	public static void main(String[] args) {
		...
		// LocalDateTime 클래스 : Java 8 부터 Date 를 대체하기 위해 사용되는 클래스
		...
		// now.withYear(2025); - 변경 안됨
		// 변경하려면 아래처럼 다시 변수안에 새롭게 받아와야 함
		...
		// Date 인스턴스의 toInstant(), toLocalDataTime()
