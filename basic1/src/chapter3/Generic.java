...
// T extends 클래스명
// : 특정 클래스 혹은 특정 클래스를 상속한 클래스만 제너릭 타입으로 받을 수 있도록 제한
...
public class Generic {
	...
	// 제너릭 메서드
	// : 해당 메서드의 매개변수의 타입이나 반환 타입을 컴파일 시에 결정하고자 할 때 사용
	// <매개타입> 반환타입 메서드명 (매개변수) { ... }
	...
	// ? extends 클래스명 : '특정 클래스' 혹은 '특정 클래스를 상속받은 클래스'만 타입으로 받을 수 있도록 제한
	static void extendsMethod (List<? extends MyClass> arg) {
		System.out.println(arg);
	}
	
	// ? super 클래스명 : '특정 클래스' 혹은 '특정 클래스의 상위 클래스'만 타입으로 받을 수 있도록 제한
	...
	public static void main(String[] args) {
		...
		// MyClass 혹은 MyClass를 상속한 클래스(자식 클래스)만 매개변수로 전달이 가능
		extendsMethod(list4);
		extendsMethod(list5);
		// extendsMethod(list3);
		// extendsMethod(list2);
		...
		// MyClass 혹은 MyClass의 부모 클래스(상위 클래스)만 매개변수로 전달할 수 있음
		superMethod(list4);
		superMethod(list3);
		// superMethod(list5);
		// superMethod(list2);
