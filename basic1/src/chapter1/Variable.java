...
public class Variable {
	...
	public static void main(String[] args) {
		...
		String websiteAddress; // 대소문자 구분함. 서로 다른 변수임.
		// - Snake Case : 띄어쓰기를 표현할 때 띄어쓰기 자리에 _(언더바)로 표현
		...
		// lowerCamelCase : 변수, 함수, 메서드 (첫문자를 소문자로 시작) - 컴파일 언어
		// UPPER_SNAKE_CASE : 상수형 변수 (모든 문자를 대문자로 작성)
		// lower_snake_case : 변수, 함수, 메서드 (모든 문자를 소문자로 작성) - 스크립트, 인터프리터 언어
